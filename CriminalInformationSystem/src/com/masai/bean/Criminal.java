...
public class Criminal {
	...
	public String toString() {
		return "Criminal [Cid=" + Cid + ", Name=" + Name + ", Age=" + Age + ", Gender=" + Gender + ", Address="
				+ Address + ", Identify_face_mark=" + Identify_face_mark + ", Crime_Area=" + Crime_Area
				+ ", Crime_Name=" + Crime_Name + "]";
	}
	public Criminal(int cid, String name, int age, String gender, String address, String identify_face_mark,
